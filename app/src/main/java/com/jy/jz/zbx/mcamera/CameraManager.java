...
//            FlashlightManager.disableFlashlight();
     ...
     * @param handler The handler to send the message to.
     * @param message The what field of the message to be sent
     * @param activity The CaptureActivity
     */
//    public void requestPreviewFrame(Handler handler, int message, CaptureActivity activity) {
//        if (camera != null && previewing) {
//            previewCallback.setHandler(handler, message, activity);
//            if (useOneShotPreviewCallback) {
//                camera.setOneShotPreviewCallback(previewCallback);
//            } else {
//                camera.setPreviewCallback(previewCallback);
...
//    }
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            Log.i("test", "-----------screenResolution.x="+screenResolution.x+" screenResolution.y="+screenResolution.y);
