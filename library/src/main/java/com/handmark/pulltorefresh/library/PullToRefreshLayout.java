...
public class PullToRefreshLayout extends RelativeLayout implements View.OnTouchListener
{
    ...
    public void refreshFinish(int refreshResult)
    {
        ...
        switch (refreshResult)
        {
            case REFRESH_SUCCEED:
                ...
                stateImageView.setBackgroundResource(R.drawable.default_ptr_flip);
                break;
            case REFRESH_FAIL:
                // 刷新失败
                stateImageView.setVisibility(View.VISIBLE);
    ...
    protected void dispatchDraw(Canvas canvas)
    {
        ...
        // 阴影的高度为26  
        LinearGradient linearGradient = new LinearGradient(0, moveDeltaY, 0, moveDeltaY - 26,0x000000, 0x00000000, Shader.TileMode.CLAMP);
